...
jobTriggered: 'Job acionado',
  ...
  changelog: {
    ...
    new_0_6_7_9: 'Links de download do desktop agora estão disponíveis no site oficial https://github.com/dseditor/hermes-web-ui-portable, e os instaladores mais recentes continuam disponíveis no GitHub Releases',
