export default {
  ...
  pair: {
    ...
    codePlaceholder: 'Enter pairing code',
    connect: 'Connect',
    codeRequired: 'Please enter a pairing code',
    failed: 'Pairing failed — check the code is correct and not expired',
  },
  pairing: {
    title: 'External Access',
    notice: 'When enabled, a temporary public URL and a one-time pairing code are created. Scan the QR or enter the code on your phone to connect — no messaging app, no manual login.',
    notConfigured: 'No external tunnel (cloudflared) is configured in this deployment.',
    loadFailed: 'Failed to load access status',
    idleHint: 'External access is off. Click below to create a temporary public URL and pairing code.',
    start: 'Enable external access',
    started: 'External access enabled',
    startFailed: 'Failed to start',
    stop: 'Stop external access',
    stopped: 'External access stopped',
    ...
    expired: 'Code expired — please regenerate',
    qrUnavailable: 'QR generation failed; use the code or URL instead',
  },
  // Plugins
  plugins: {
    title: 'Extensions',
    refresh: 'Refresh',
    notice: 'Manage Hermes extensions by category. For image / video generation you can pick a provider and enter its key right here; saving writes to the current profile and takes effect in new Hermes sessions. (Messaging apps live under "Channels", models under "Models".)',
    providerLabel: 'Provider',
    selectProvider: 'Select a provider...',
    providerHint: 'Pick a provider, enter its key, then Save — no CLI command needed.',
    save: 'Save',
    saved: 'Settings saved',
    saveFailed: 'Save failed',
    nothingToSave: 'Nothing to save',
    envSet: 'set',
    envPlaceholder: 'Enter key / value',
    envKeepPlaceholder: 'Already set — leave blank to keep',
    category: {
    ...
    categoryDesc: {
      image_gen: 'Pick the image-generation provider and enter its key; image_generate routes to it once set.',
      video_gen: 'Pick the video-generation provider and enter its key; video_generate routes to it once set.',
      web: 'Web-search backends — enter the key for the service you want to use.',
      browser: 'Browser-automation backends.',
      memory: 'Long-term memory backends.',
      observability: 'Observability / tracing backends.',
    },
  ...
  settings: {
    ...
    browser: {
      intro: 'Connect the agent\'s browser tools to a local Chromium-family browser via CDP. It first tries to connect to a browser already listening on the port; if none, it launches a visible Chrome on the persistent login profile so you can log in.',
      cdpUrl: 'CDP URL',
      cdpUrlHint: 'Debug address the agent connects to. Default http://127.0.0.1:9222.',
      chromePath: 'Browser executable path',
      chromePathHint: 'Leave empty to auto-detect system Chrome/Edge; set to override.',
      chromePathPlaceholder: 'Empty = auto-detect (unchanged)',
      launch: 'Launch & connect',
      launchHint: 'Connect to an existing browser, or launch Chrome on the persistent login profile and write config.',
      launchButton: 'Launch & connect',
      launchStarted: 'Browser triggered (port {port}). If newly launched, log in to the window that opens.',
  ...
  platform: {
    ...
    lineChannelAccessTokenHint: 'Long-lived channel access token from the LINE Developers Console',
    lineChannelSecret: 'Channel Secret',
    lineChannelSecretHint: 'Channel secret (used for HMAC-SHA256 webhook verification)',
    linePublicUrl: 'Public URL',
    linePublicUrlHint: 'Public HTTPS base URL for sending media (image / voice / video)',
    lineAllowedUsers: 'Allowed Users',
    lineAllowedUsersHint: 'Comma-separated user IDs (U-prefixed)',
    lineAllowedGroups: 'Allowed Groups',
    lineAllowedGroupsHint: 'Comma-separated group IDs (C-prefixed)',
    lineAllowedRooms: 'Allowed Rooms',
    lineAllowedRoomsHint: 'Comma-separated room IDs (R-prefixed)',
    lineHomeChannel: 'Home Channel',
    lineHomeChannelHint: 'Target for cron / notification delivery (optional)',
    botId: 'Bot ID',
  ...
  files: {
    ...
    list: 'File List',
    breadcrumbRoot: 'Home',
    setAsWorkspace: 'Set as working folder',
    workspaceSet: 'Working folder set: {path}',
    workspaceSetFailed: 'Failed to set working folder',
    noActiveSession: 'Open a conversation first',
    newFile: 'New File',
  ...
  changelog: {
    ...
    new_0_6_7_9: 'Desktop download links are now available on the official website at https://github.com/dseditor/hermes-web-ui-portable, and the latest installers remain available from GitHub Releases',
