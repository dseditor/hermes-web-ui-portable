...
<template>
  <section class="settings-section">
    ...
    >
      ...
      <!-- LINE -->
      <template v-if="p.key === 'line'">
        <SettingRow :label="t('platform.lineChannelAccessToken')" :hint="t('platform.lineChannelAccessTokenHint')">
          <NInput :value="credentialDraft('line').channel_access_token || ''" :loading="isSavingPlatform('line')" clearable size="small" class="input-lg" placeholder="Long-lived channel access token" @update:value="v => setCredentialDraft('line', { channel_access_token: v })" />
        </SettingRow>
        <SettingRow :label="t('platform.lineChannelSecret')" :hint="t('platform.lineChannelSecretHint')">
          <NInput :value="credentialDraft('line').channel_secret || ''" :loading="isSavingPlatform('line')" clearable size="small" class="input-lg" placeholder="Channel secret" @update:value="v => setCredentialDraft('line', { channel_secret: v })" />
        </SettingRow>
        <SettingRow :label="t('platform.linePublicUrl')" :hint="t('platform.linePublicUrlHint')">
          <NInput :value="configDraft('line').public_url || ''" :loading="isSavingPlatform('line')" clearable size="small" class="input-lg" placeholder="https://your-tunnel.example.com" @update:value="v => setConfigDraft('line', { public_url: v })" />
        </SettingRow>
        <SettingRow :label="t('platform.allowAllUsers')" :hint="t('platform.allowAllUsersHint')">
          <NSwitch :value="configDraft('line').allow_all_users" :loading="isSavingPlatform('line')" @update:value="v => setConfigDraft('line', { allow_all_users: v })" />
        </SettingRow>
        <SettingRow :label="t('platform.lineAllowedUsers')" :hint="t('platform.lineAllowedUsersHint')">
          <NInput :value="configDraft('line').allowed_users || ''" :loading="isSavingPlatform('line')" size="small" placeholder="U1234...,U5678..." @update:value="v => setConfigDraft('line', { allowed_users: v })" />
        </SettingRow>
        <SettingRow :label="t('platform.lineAllowedGroups')" :hint="t('platform.lineAllowedGroupsHint')">
          <NInput :value="configDraft('line').allowed_groups || ''" :loading="isSavingPlatform('line')" size="small" placeholder="C1234...,C5678..." @update:value="v => setConfigDraft('line', { allowed_groups: v })" />
        </SettingRow>
        <SettingRow :label="t('platform.lineAllowedRooms')" :hint="t('platform.lineAllowedRoomsHint')">
          <NInput :value="configDraft('line').allowed_rooms || ''" :loading="isSavingPlatform('line')" size="small" placeholder="R1234...,R5678..." @update:value="v => setConfigDraft('line', { allowed_rooms: v })" />
        </SettingRow>
        <SettingRow :label="t('platform.lineHomeChannel')" :hint="t('platform.lineHomeChannelHint')">
          <NInput :value="configDraft('line').extra?.home_channel || ''" :loading="isSavingPlatform('line')" size="small" placeholder="U... / C... / R..." @update:value="v => setConfigDraft('line', { extra: { ...configDraft('line').extra, home_channel: v } })" />
        </SettingRow>
      </template>
