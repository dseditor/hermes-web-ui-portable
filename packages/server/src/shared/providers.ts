 ...
 *
 * Ordering convention: mainstream / international providers are listed first,
 * followed by local runners and other / China-region providers.
 */
...
export const PROVIDER_PRESETS: ProviderPreset[] = [
  ...
  },
  {
    ...
    value: 'nvidia',
    builtin: true,
    base_url: 'https://build.nvidia.com/v1',
    api_mode: 'chat_completions',
    models: [
  ...
  // ───────────────────────── Local runners & other / China-region ─────────────────────────
  {
    label: 'LM Studio',
    value: 'lmstudio',
    builtin: true,
